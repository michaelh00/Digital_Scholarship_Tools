...
# # Basic Data Visualization Procedures: Multidimensional Data
...
# In a typical 2-dimensional scatter plot, two columns of a data set are plotted, one on the x-axis, the other on the y-axis.   
...
# The following diagram shows the effect of binning for the visualization of the Iris data in column "sepal_length (cm)". Note that the generation of a histogram only requires minor changes in the code previously used for the generation of scatter plots. 
